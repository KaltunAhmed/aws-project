...
- [Steps](#steps)
  ...
  - [Step 7: Setting Up WordPress](#step-7-rreate-wordpress-database)
  - [Step 8: Configuring NGINX for WordPress](#step-8-configuring-nginx-for-wordpress)
  - [Step 9: Completing WordPress Installation](#step-9-create-an-nginx-virtual-host-configuration-file)
